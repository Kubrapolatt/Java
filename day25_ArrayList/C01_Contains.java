...
public class C01_Contains {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tekrarsız List" + tekrarsız); //Tekrarsız List[2, 3, 4, 5, 6, 7, 8, 9, 1, 0]
	   ...
	   System.out.println("Tekrarsız Array" + Arrays.toString(tekrarsızArray)); //Tekrarsız Array[2, 3, 4, 5, 6, 7, 8, 9, 1, 0]
