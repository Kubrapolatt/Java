...
“farkli isaretlerde sayilarla islem yapamazsin” 
yazdirin, sayilardan sifira esit olan varsa “sifir 
carpmaya gore yutan elemandir” yazdirin.*/
		
		
	Scanner scan=new Scanner(System.in);
	
	System.out.println("Lütfen iki sayı giriniz \n ilk sayıdan sonra diğeri sayı için enter a basınız için");
	...
	if (sayi1>0 && sayi2>0) {
		...
		System.out.println("carpmaya gore yutan elemandir");
